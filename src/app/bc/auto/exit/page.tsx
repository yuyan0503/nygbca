...
export default function Page() {
  ...
  const onNewScanResult = async (decodedText: any, decodedResult: any) => {
    ...
    try {
      ...
      if (!isInside) {
        throw new Error("still outside!")
      }
      setProgramState("confirmExit")
    ...
    return (
      <div className="relative min-h-screen">
        ...
        <div className="mx-auto w-full max-w-xs flex flex-col items-center justify-center min-h-screen">
          <div className="prose">
            <h1 className="mb-4 text-center">Automatic BC Exit</h1>
          </div>
  ...
  } else if (programState == "confirmExit") {
    return (
      ...
      <div className="relative bg-green-500 text-white min-h-screen">
        ...
        <div className="mx-auto w-full max-w-xs flex flex-col items-center justify-center min-h-screen">
          ...
          <p className="mb-2">You are now leaving the premises.</p>
        </div>
      </div>
    )
    ...
    return (
      ...
      <div className="relative bg-red-500 text-white min-h-screen">
        ...
        <div className="mx-auto w-full max-w-xs flex flex-col items-center justify-center min-h-screen">
          ...
          <p className="mb-2">Leaving denied, please seek assistance.</p>
        </div>
      </div>
    )
  } else {
